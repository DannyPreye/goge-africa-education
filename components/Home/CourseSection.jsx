    ...
    <section className='bg-pink grid place-items-center'>
      <div className='container mx-auto'>
        <div className='pt-[120px]  '>
          ...
          <ul className='flex gap-[34px] mt-[34px] justify-center flex-wrap '>
          ...
          <div className='grid md:block place-items-center lg:block'>
            <div className='  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-[15px]  lg:gap-x-[9px] mt-[55px]'>
